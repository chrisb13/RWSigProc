...
if __name__ == "__main__": 
    ...
    infile='/srv/ccrc/data48/z3457920/20151012_eac_sep_dynamics_fxd_stress/analysis2/hovmollers/test/nemo_cordex24_DFLX_CTRL02_test_type_straight_lat.h5'
    infile='/srv/ccrc/data48/z3457920/20151012_eac_sep_dynamics_fxd_stress/analysis2/hovmollers/test/nemo_cordex24_DFLX_FLATFCNG_01_test_type_straight_lat.h5'
    
    infile='/srv/ccrc/data48/z3457920/20151012_eac_sep_dynamics_fxd_stress/analysis2/hovmollers/test/nemo_cordex24_DFLX_3xVERAIWNDHGH_01_test_type_straight_lat.h5'
    infile='/srv/ccrc/data48/z3457920/20151012_eac_sep_dynamics_fxd_stress/analysis2/hovmollers/test/nemo_cordex24_DFLX_3xVERAIWNDHGH_01_test_type_straight_lat.h5'

    import glob
    ifiles=sorted(glob.glob('/srv/ccrc/data48/z3457920/20151012_eac_sep_dynamics_fxd_stress/analysis2/hovmollers/ppolito_filter/*.h5'))
    assert(ifiles!=[]),"glob didn't find anything!"

    for infile in ifiles:
        efile=pout+'example_sombrero_nemo'+os.path.basename(infile)[:38]+'.png'
        if os.path.exists(efile):
            lg.warning("File: "+os.path.basename(efile)+" already existed, so skipping")
            continue
    ...
    #    zf=nd.convolve(df.values,fa) # memory issues with large matrices, try this:
        ...
        # efile=pout+'example_sombrero_nemo_flat.png'
        fig.savefig(efile,dpi=150,bbox_inches='tight')
